...
export const useThemeStore = defineStore('theme', {
    ...
    actions: {
        setThemeOnLoad() {
            ...
            //PER IL MOMENTO è COMMENTATO PERCHè NON MI FUNZIONA BENE CON ALCUNI BROWSER,
            //DEVO INDAGARE MA SECONDO ME LA VERSIONE GIUSTA è QUESTA QUI SOTTO, SOSTITUIRLA CON TUTTO QUELLO CHE C'è SOPRA
