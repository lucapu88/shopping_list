  ...
  actions: {
    ...
    checkAndSetSuggestionsLanguage(catName) { //TOFIX Sicuramente migliorabile sto coso gigante di merda qui sotto!
      ...
      switch (categoryName) {
        ...
        case 'stationery':
          this.suggestionsList = ["Pencils", "Markers", "Ruler", "Highlighters", "Pens", "Colors", "Erasers", "Notepads", "Notebooks", "Drawing albums", "Correction fluid", "Scissors", "Rulers", "Glue", "Adhesive tape", "Folders", "Cardstock", "Paper clips", "Stapler", "Stapler refills", "Post-it notes"];
          break;
        ...
        case 'toys':
          this.suggestionsList = ["Dolls", "Toy cars", "Puzzles", "Building blocks", "Play kitchen set", "Soccer balls", "Painting and coloring sets", "Board games", "Tricycles", "Pokemon cards", "Magic the gathering cards", "Garden toys", "Science kits", "Toy trains", "Board games", "Cards", "Bicycle", "Electric scooter", "Remote control car", "Game boy", "Play station", "Xbox"];
          break;
        ...
        case 'other':
          this.suggestionsList = ["Salt", "Eggs", "Snacks", "Energy bars", "Packaged chips", "Pretzels", "Chocolates", "Popcorn", "Soy sauce", "Barbecue sauce", "Ketchup", "Mayonnaise", "Dried fruit", "Breakfast cereals", "Batteries", "Lighter", "Parchment paper", "Aluminum foil", "Candles", "Rubber bands", "String"];
          break;

        case 'christmas gifts':
          this.suggestionsList = ["We do not think we can give you suggestions for this category as it is too subjective.",
        ...
        case 'altro':
          this.suggestionsList = ["Sale", "Uova", "Snack", "Barrette energetiche", "Patatine confezionate", "Salatini", "Cioccolatini", "Popcorn", "Salsa di soia", "Salsa barbecue", "ketchup", "Maionese", "Frutta secca", "Cereali per la colazione", "Pile", "Accendino", "Carta da forno", "Fogli di alluminio", "Candele", "Elastici", "Spago"];
          break;

        case 'regali di natale':
          this.suggestionsList = ["Non crediamo di riuscire a darvi suggerimenti per questa categoria poiché è troppo soggettiva.",
        ...
        case 'otros':
          this.suggestionsList = ["Pabellones", "Huevos", "Aperitivos", "Barras energéticas", "Patatas fritas envasadas", "Galletas saladas", "Chocolates", "Palomitas", "Salsa de soja", "Salsa barbacoa", "Ketchup", "Mayonesa", "Frutos secos", "Cereales para el desayuno", "Pilas", "Encendedor", "Papel de horno", "Papel de aluminio", "Velas", "Bandas elásticas", "Cuerda"];
          break;

        case 'regalos de navidad':
          this.suggestionsList = ["No creemos que podamos darle sugerencias para esta categoría, ya que es demasiado subjetiva.",
