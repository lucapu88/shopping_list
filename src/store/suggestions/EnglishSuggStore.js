...
export const useEnglishSuggStoreStore = defineStore('english', {
    state: () => ({
        ...
        other: ["Salt", "Eggs", "Snacks", "Energy bars", "Packaged chips", "Pretzels", "Chocolates", "Popcorn", "Soy sauce", "Barbecue sauce", "Ketchup", "Mayonnaise", "Dried fruit", "Breakfast cereals", "Batteries", "Lighter", "Parchment paper", "Aluminum foil", "Candles", "Rubber bands", "String"],
