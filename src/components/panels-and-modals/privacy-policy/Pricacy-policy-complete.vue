...
<template>
  ...
  <div>
    <h1>Privacy Policy for Luca Caputo</h1>
    ...
    <p>
      ...
      recorded by Shopping List and how we use it.
    </p>
    ...
    <p>
      Shopping List follows a standard procedure of using log files. These files
    ...
    <p>
      ...
      advertisements and links that appear on Shopping List, which are sent
    ...
    <p>
      Note that Shopping List has no access to or control over these cookies
    ...
    <p>
      Shopping List's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Shopping List does not knowingly collect any Personal Identifiable
