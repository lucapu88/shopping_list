...
<style scoped>
.modal-background {
	background-image: url("@/img/shared.webp");
...
.fuchsia {
	background-color: #c40ac4;
}
.violet {
	background-color: #7103c4;
}
</style>
